...
public class LocalStack extends Stack {
        ...
        private Vpc createVpc() {
                return Vpc.Builder
                                .create(this, "PatientManagementVPC") // this means vpc is added to current stack
        ...
        // auth-service.patient-management.local //service discovery handles service
        // findings via namespace
        ...
        public static void main(final String[] args) {
                App app = new App(AppProps.builder().outdir("./cdk.out").build()); // create new aws cdk app and giving
                                                                                   // location
                                                                                   // for it to create
                StackProps props = StackProps.builder().synthesizer(new BootstraplessSynthesizer()).build(); // synthesizer
                                                                                                             // is
                                                                                                             // used to
                                                                                                             // create
                                                                                                             // cloud
